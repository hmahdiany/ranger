...
def partial_kind_dump(ns_list, kind_list, result_dir):
    """
    create a dump for specific kinds in all user defined namespaces 
    which are passed through --kind option via cli
    """
